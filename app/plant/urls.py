...
urlpatterns = [
    ...
    # TODO: use or remove
    #re_path(r'^ajax/plant/autocomplete/(?P<search_item>\w+)/(?P<limit_by>\d+)$',
    ...
    #re_path(r'^ajax/individual/autocomplete/plant/(?P<limit_by>\d+)$',
    #                                        views.ajax_autocomplete_individual_species,
    #                                                                            name='ajax_autocomplete_individual_species'),
    #re_path(r'^ajax/plant/name/(?P<forId>\d+)$',
